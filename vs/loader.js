// was obfuscated for some reason
// i deobfuscated :thumbsup:
...
!function (e) {
  ...
  var t = function () {
    function t() {
      this._detected = false, this._isWindows = false, this._isNode = false, this._isElectronRenderer = false, this._isWebWorker = false;
    }
    return Object.defineProperty(t.prototype, "isWindows", {get: function () {
      return this._detect(), this._isWindows;
    }, enumerable: true, configurable: true}), Object.defineProperty(t.prototype, "isNode", {get: function () {
      return this._detect(), this._isNode;
    }, enumerable: true, configurable: true}), Object.defineProperty(t.prototype, "isElectronRenderer", {get: function () {
      return this._detect(), this._isElectronRenderer;
    }, enumerable: true, configurable: true}), Object.defineProperty(t.prototype, "isWebWorker", {get: function () {
      return this._detect(), this._isWebWorker;
    }, enumerable: true, configurable: true}), t.prototype._detect = function () {
      this._detected || (this._detected = true, this._isWindows = t._isWindows(), this._isNode = "undefined" != typeof module && !!module.exports, this._isElectronRenderer = "undefined" != typeof process && undefined !== process.versions && undefined !== process.versions.electron && "renderer" === process.type, this._isWebWorker = "function" == typeof e.global.importScripts);
...
!function (e) {
  var t = function () {
    ...
    return t.fileUriToFilePath = function (e, t) {
      ...
      return this.PERFORMANCE_NOW_PROBED || (this.PERFORMANCE_NOW_PROBED = true, this.HAS_PERFORMANCE_NOW = e.global.performance && "function" == typeof e.global.performance.now), this.HAS_PERFORMANCE_NOW ? e.global.performance.now() : Date.now();
    }, t.NEXT_ANONYMOUS_ID = 1, t.PERFORMANCE_NOW_PROBED = false, t.HAS_PERFORMANCE_NOW = false, t;
  }();
  e.Utilities = t;
}(AMDLoader || (AMDLoader = {}));
!function (e) {
  var t = function () {
    ...
    return t.validateConfigurationOptions = function (t) {
      ...
      undefined === r && (r = null), undefined === n && (n = null);
      var o = e.Utilities.recursiveClone(n || {});
      return e.Utilities.forEachProperty(r, function (t, r) {
        "ignoreDuplicateModules" === t && undefined !== o.ignoreDuplicateModules ? o.ignoreDuplicateModules = o.ignoreDuplicateModules.concat(r) : "paths" === t && undefined !== o.paths ? e.Utilities.forEachProperty(r, function (e, t) {
          return o.paths[e] = t;
        }) : "config" === t && undefined !== o.config ? e.Utilities.forEachProperty(r, function (e, t) {
          return o.config[e] = t;
  ...
  var r = function () {
    function r(e, r) {
      if (this._env = e, this.options = t.mergeConfigurationOptions(r), this._createIgnoreDuplicateModulesMap(), this._createNodeModulesMap(), this._createSortedPathsRules(), "" === this.options.baseUrl) {
        if (this.options.nodeRequire && this.options.nodeRequire.main && this.options.nodeRequire.main.filename && this._env.isNode) {
          var n = this.options.nodeRequire.main.filename, o = Math.max(n.lastIndexOf("/"), n.lastIndexOf("\\"));
          this.options.baseUrl = n.substring(0, o + 1);
        }
        if (this.options.nodeMain && this._env.isNode) {
          var n = this.options.nodeMain, o = Math.max(n.lastIndexOf("/"), n.lastIndexOf("\\"));
          this.options.baseUrl = n.substring(0, o + 1);
        }
      }
    }
    return r.prototype._createIgnoreDuplicateModulesMap = function () {
      ...
      for (var e = 0; e < this.options.ignoreDuplicateModules.length; e++) this.ignoreDuplicateModulesMap[this.options.ignoreDuplicateModules[e]] = true;
    }, r.prototype._createNodeModulesMap = function () {
      this.nodeModulesMap = Object.create(null);
      for (var e = 0, t = this.options.nodeModules; e < t.length; e++) {
        var r = t[e];
        this.nodeModulesMap[r] = true;
      }
      ...
      this.sortedPathsRules = [], e.Utilities.forEachProperty(this.options.paths, function (e, r) {
        Array.isArray(r) ? t.sortedPathsRules.push({from: e, to: r}) : t.sortedPathsRules.push({from: e, to: [r]});
      ...
      if (true === this.nodeModulesMap[t]) return this.isBuild() ? ["empty:"] : ["node|" + t];
      var r, n = t;
...
!function (e) {
  var t = function () {
    ...
    function t(e) {
      this._env = e, this._didInitialize = false, this._didPatchNodeRequire = false;
    }
    return t.prototype._init = function (e) {
      if (!this._didInitialize) {
        this._didInitialize = true, this._fs = e("fs"), this._vm = e("vm"), this._path = e("path"), this._crypto = e("crypto"), this._jsflags = "";
      ...
      if (n && !this._didPatchNodeRequire) {
        ...
        var o = this, i = t("module");
        i.prototype._compile = function (t, s) {
          t = t.replace(/^#!.*/, "");
          var d = i.wrap(t), a = o._getCachedDataPath(n, s), u = {filename: s};
          try {
            u.cachedData = o._fs.readFileSync(a);
          } catch (e) {
            u.produceCachedData = true;
          }
          var l = new o._vm.Script(d, u), c = l.runInThisContext(u), h = o._path.dirname(s), f = function (e) {
          ...
          }(this), p = [this.exports, f, this, s, h, process, e.global, Buffer], _ = c.apply(this.exports, p);
          return o._processCachedData(r, l, a), _;
        };
      }
    }, t.prototype.load = function (r, n, o, i) {
      var s = this, d = r.getConfig().getOptionsLiteral(), a = d.nodeRequire || e.global.nodeRequire, u = d.nodeInstrumenter || function (e) {
        return e;
      };
      ...
      } else n = e.Utilities.fileUriToFilePath(this._env.isWindows, n), this._fs.readFile(n, {encoding: "utf8"}, function (e, a) {
        if (e) i(e); else {
          var c = s._path.normalize(n), h = c;
          ...
          if (p = a.charCodeAt(0) === t._BOM ? _ + a.substring(1) + "\n});" : _ + a + "\n});", p = u(p, c), d.nodeCachedDataDir) {
            ...
            s._fs.readFile(g, function (e, t) {
              var i = {filename: h, produceCachedData: undefined === t, cachedData: t}, d = s._loadAndEvalScript(r, n, h, p, i, l);
              o(), s._processCachedData(r, d, g);
            });
          } else s._loadAndEvalScript(r, n, h, p, {filename: h}, l), o();
        }
      });
      ...
      var r = this._crypto.createHash("md5").update(t, "utf8").update(this._jsflags, "utf8").digest("hex"), n = this._path.basename(t).replace(/\.js$/, "");
      return this._path.join(e, n + "-" + r + ".code");
    }, t.prototype._processCachedData = function (e, r, n) {
      var o = this;
      r.cachedDataRejected ? (e.getConfig().getOptionsLiteral().onNodeCachedData({errorCode: "cachedDataRejected", path: n}), t._runSoon(function () {
        return o._fs.unlink(n, function (t) {
          t && e.getConfig().getOptionsLiteral().onNodeCachedData({errorCode: "unlink", path: n, detail: t});
        });
      }, e.getConfig().getOptionsLiteral().nodeCachedDataWriteDelay)) : r.cachedDataProduced && (e.getConfig().getOptionsLiteral().onNodeCachedData(undefined, {path: n, length: r.cachedData.length}), t._runSoon(function () {
        return o._fs.writeFile(n, r.cachedData, function (t) {
          t && e.getConfig().getOptionsLiteral().onNodeCachedData({errorCode: "writeFile", path: n, detail: t});
        });
...
!function (e) {
  ...
  var r = function () {
    function t(e, t, r, n, o, i) {
      this.id = e, this.strId = t, this.dependencies = r, this._callback = n, this._errorback = o, this.moduleIdResolver = i, this.exports = {}, this.exportsPassedIn = false, this.unresolvedDependenciesCount = this.dependencies.length, this._isComplete = false;
    }
    return t._safeInvokeFunction = function (t, r) {
      ...
      return t.isBuild() && !e.Utilities.isAnonymousModule(r) ? {returnedValue: null, producedError: null} : t.shouldCatchError() ? this._safeInvokeFunction(n, o) : {returnedValue: n.apply(e.global, o), producedError: null};
      ...
      if (this._callback) if ("function" == typeof this._callback) {
        ...
        i = s.producedError, r.record(22, this.strId), i || undefined === s.returnedValue || this.exportsPassedIn && !e.Utilities.isEmpty(this.exports) || (this.exports = s.returnedValue);
      } else this.exports = this._callback;
      i && n.onError({errorCode: "factory", moduleId: this.strId, detail: i}), this.dependencies = null, this._callback = null, this._errorback = null, this.moduleIdResolver = null;
    }, t.prototype.onDependencyError = function (e) {
      return !!this._errorback && (this._errorback(e), true);
  ...
  var n = function () {
    ...
    return e.prototype.getMaxModuleId = function () {
      ...
      return undefined === t && (t = this._nextId++, this._strModuleIdToIntModuleId.set(e, t), this._intModuleIdToStrModuleId[t] = e), t;
  ...
  var s = function () {
    ...
    return s.prototype.reset = function () {
      ...
      for (var n = e.replace(/\\/g, "/"), o = t.split(/\n/), i = 0; i < o.length; i++) {
        var s = o[i].match(/(.*):(\d+):(\d+)\)?$/);
        if (s) {
          var d = s[1], a = s[2], u = s[3], l = Math.max(d.lastIndexOf(" ") + 1, d.lastIndexOf("(") + 1);
          if (d = d.substr(l), (d = d.replace(/\\/g, "/")) === n) {
      ...
      for (var e = [], t = 0, r = 0, n = this._modules2.length; r < n; r++) {
        ...
        if (o) {
          var i = this._buildInfoPath[o.id] || null, d = this._buildInfoDefineStack[o.id] || null, a = this._buildInfoDependencies[o.id];
          e[t++] = {id: o.strId, path: i, defineLocation: i && d ? s._findRelevantLocationInStack(i, d) : null, dependencies: a, shim: null, exports: o.exports};
        }
      }
      return e;
      ...
      var r = null;
      this._config.isBuild() && (r = new Error("StackLocation").stack), this._currentAnnonymousDefineCall = {stack: r, dependencies: e, callback: t};
    }, s.prototype.defineModule = function (e, n, o, i, s, d) {
      var a = this;
      undefined === d && (d = new t(e));
      ...
      var r = e.indexOf("!");
      if (r >= 0) {
        var n = t.resolveModule(e.substr(0, r)), s = t.resolveModule(e.substr(r + 1)), d = this._moduleIdProvider.getModuleId(n + "!" + s), a = this._moduleIdProvider.getModuleId(n);
        return new i(d, a, s);
      }
      ...
      var r = this;
      return {errorCode: "load", moduleId: this._moduleIdProvider.getStrModuleId(e), neededBy: (this._inverseDependencies2[e] || []).map(function (e) {
        return r._moduleIdProvider.getStrModuleId(e);
      }), detail: t};
    }, s.prototype._onLoadError = function (e, t) {
      for (var r = this._createLoadError(e, t), n = [], o = 0, i = this._moduleIdProvider.getMaxModuleId(); o < i; o++) n[o] = false;
      var s = false, d = [];
      for (d.push(e), n[e] = true; d.length > 0;) {
        var a = d.shift(), u = this._modules2[a];
        u && (s = u.onDependencyError(r) || s);
        var l = this._inverseDependencies2[a];
        if (l) for (var o = 0, i = l.length; o < i; o++) {
          var c = l[o];
          n[c] || (d.push(c), n[c] = true);
        }
      }
      ...
      if (!r) return false;
      for (var n = [], o = 0, i = this._moduleIdProvider.getMaxModuleId(); o < i; o++) n[o] = false;
      var s = [];
      for (s.push(r), n[e] = true; s.length > 0;) {
        var d = s.shift().dependencies;
        if (d) for (var o = 0, i = d.length; o < i; o++) {
          var a = d[o];
          if (a.id === t) return true;
          var u = this._modules2[a.id];
          u && !n[a.id] && (n[a.id] = true, s.push(u));
        }
      }
      return false;
      ...
      for (var t = this, r = e.dependencies, n = 0, s = r.length; n < s; n++) {
        ...
        } else e.unresolvedDependenciesCount--; else e.unresolvedDependenciesCount--; else e.exportsPassedIn = true, e.unresolvedDependenciesCount--;
      }
...
!function (e) {
  function t() {
    if (undefined !== e.global.require || "undefined" != typeof require) {
  ...
  var r = new e.Environment, n = null, o = function (e, t, r) {
  ...
  o.amd = {jQuery: true};
  var i = function (e, t) {
    undefined === t && (t = false), n.configure(e, t);
  }, s = function () {
  ...
  }, e.init = t, "function" == typeof e.global.define && e.global.define.amd || (n = new e.ModuleManager(r, e.createScriptLoader(r), o, s, e.Utilities.getHighPerformanceTimestamp()), undefined !== e.global.require && "function" != typeof e.global.require && s.config(e.global.require), (define = function () {
